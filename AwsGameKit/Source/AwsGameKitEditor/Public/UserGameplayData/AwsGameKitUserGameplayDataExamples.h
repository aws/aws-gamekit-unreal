...
private:
    ...
    void CallAddDataApi();
    void OnAddDataComplete(const IntResult& result, const FUserGameplayDataBundle& unprocessedItems);
    ...
    FString ListBundlesReturnValue;

    UPROPERTY(Transient, VisibleInstanceOnly, Category = "3. List User Gameplay Data Bundles", DisplayName = "Response:")
    TArray<FString> ListBundlesResponse;
    ...
    UPROPERTY(Transient, VisibleInstanceOnly, Category = "4. Get Bundle", DisplayName = "Return Value:")
    FString GetBundleReturnValue;

    UPROPERTY(Transient, VisibleInstanceOnly, Category = "4. Get Bundle", DisplayName = "Response:")
    TMap<FString, FString> GetBundleResponse;
    ...
    UPROPERTY(Transient, VisibleInstanceOnly, Category = "5. Get Bundle Item", DisplayName = "Response:")
    FString GetBundleItemResponse;
    ...
    UPROPERTY(Transient, EditInstanceOnly, Category = "9. Delete Bundle Items", DisplayName = "Bundle Item Keys:")
