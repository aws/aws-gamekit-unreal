...
struct FGameSavingSlotActionResults
{
     ...
     *
     * GAMEKIT_SUCCESS on success, else a non-zero value. Consult the API's documentation for details, or consult the AwsGameKit/Libraries/include/aws/gamekit/core/errors.h file.
     */
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "AWS GameKit | Game Saving")
    int32 CallStatus = 0;
};
