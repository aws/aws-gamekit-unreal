...
// GameKit
#include "AwsGameKitSessionManagerModels.h"
...
public:
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "AWS GameKit | SessionManager")
    static bool AreSettingsLoaded(const FeatureType_E featureType);
