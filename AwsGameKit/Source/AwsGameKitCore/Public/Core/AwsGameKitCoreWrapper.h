...
private:
    /**
    * AWS SDK function pointer handles
    */
    DEFINE_FUNC_HANDLE(unsigned int, GameKitInitializeAwsSdk, (FuncLogCallback logCb));
    ...
    */
    ...
    DEFINE_FUNC_HANDLE(unsigned int, GameKitAccountSaveFeatureInstanceTemplates, (void* accountInstance));
    ...
    */
    ...
    DEFINE_FUNC_HANDLE(unsigned int, GameKitResourcesCreateEmptyConfigFile, (void* resourceInstance));
    ...
    DEFINE_FUNC_HANDLE(unsigned int, GameKitResourcesGetCurrentStackStatus, (void* resourceInstance, DISPATCH_RECEIVER_HANDLE receiver, CharPtrCallback resultsCb));
    ...
    DEFINE_FUNC_HANDLE(unsigned int, GameKitResourcesSaveCloudFormationInstance, (void* resourceInstance));
    DEFINE_FUNC_HANDLE(unsigned int, GameKitResourcesUpdateCloudFormationParameters, (void* resourceInstance));
...
#pragma region AWS SDK
     ...
     */
    virtual unsigned int GameKitInitializeAwsSdk(FuncLogCallback logCb);
#pragma endregion
...
#pragma region GameKitAccount
     ...
     * @return The result code of the operation. GAMEKIT_SUCCESS if successful, else a non-zero value in case of error. Consult errors.h file for details.
     */
    virtual unsigned int GameKitAccountSaveFeatureInstanceTemplates(GAMEKIT_ACCOUNT_INSTANCE_HANDLE accountInstance);
...
#pragma region GameKitFeatureResources
     ...
     * @return The result code of the operation. GAMEKIT_SUCCESS if successful, else a non-zero value in case of error. Consult errors.h file for details.
     */
    virtual unsigned int GameKitResourcesCreateEmptyConfigFile(GAMEKIT_FEATURERESOURCES_INSTANCE_HANDLE resourceInstance);
     ...
     * @return The result code of the operation. GAMEKIT_SUCCESS if successful, else a non-zero value in case of error. Consult errors.h file for details.
     */
    virtual unsigned int GameKitResourcesGetCurrentStackStatus(GAMEKIT_FEATURERESOURCES_INSTANCE_HANDLE resourceInstance, DISPATCH_RECEIVER_HANDLE receiver, CharPtrCallback resultsCb);
     ...
     * @return The result code of the operation. GAMEKIT_SUCCESS if successful, else a non-zero value in case of error. Consult errors.h file for details.
     */
    virtual unsigned int GameKitResourcesSaveCloudFormationInstance(GAMEKIT_FEATURERESOURCES_INSTANCE_HANDLE resourceInstance);
     ...
     * @return The result code of the operation. GAMEKIT_SUCCESS if successful, else a non-zero value in case of error. Consult errors.h file for details.
     */
    virtual unsigned int GameKitResourcesUpdateCloudFormationParameters(GAMEKIT_FEATURERESOURCES_INSTANCE_HANDLE resourceInstance);
...
#pragma region GameKitSettings
     ...
     * @param currentEnvironment The current active environment based on what was selected in Environment and Credentials category eg "dev", "qa", custom
    ...
    /**
     * @brief Add a custom deployment environment to the AWS Environment and Credentials menu.
     *
     * @details This custom environment will be available to select from the dropdown menu in the plugin's AWS Environment and Credentials,
     ...
     * @param envDescription The environment name that will be displayed in the AWS Environment and Credentials. Ex: "Gamma".
     */
    ...
    /**
     * @brief Remove a custom deployment environment from the AWS Environment and Credentials menu.
     *
