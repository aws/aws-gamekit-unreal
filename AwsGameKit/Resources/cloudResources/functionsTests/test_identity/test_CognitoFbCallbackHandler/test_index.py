...
class TestIndex(TestCase):
    ...
    def get_decrypted_state_for_new_user():
        ...
        email and password yet and haven't signed in through an identity provider before (Facebook, etc.).
        """
        state = {
    ...
    def get_decrypted_state_for_existing_user():
        ...
        email and password or have already signed in through a different identity provider (ex: Facebook.).
        """
        state = {
            'request_id': '7b8961cb-19db-47e3-88cb-afcd9884b81d',
            'expiration': 9999999999,
