...
public:
    ...
    */
    static void AddBundle(const FUserGameplayDataBundle& userGameplayDataBundle, FAwsGameKitStatusDelegateParam OnCompleteDelegate);
    ...
    */
     ...
     * - GAMEKIT_ERROR_GENERAL: The request has failed unknown reason.
    */
    static void ListBundles(const TAwsGameKitDelegateParam<const IntResult&, const TArray<FString>&> ResultDelegate);
