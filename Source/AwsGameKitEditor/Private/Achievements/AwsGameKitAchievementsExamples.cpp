...
bool AAwsGameKitAchievementsExamples::InitializeAchievementsLibrary()
{
    ...
    if (!ReloadSettings())
    {
        FMessageDialog::Open(EAppMsgType::Ok, FText::FromString("You need to deploy the Achievements feature first."));
        return false;
    }
    ...
    if(BaseIconUrl.IsEmpty())
    {
        ...
        auto Delegate = MakeAwsGameKitDelegate(this, &AAwsGameKitAchievementsExamples::OnGetIconBaseUrlComplete);
...
void AAwsGameKitAchievementsExamples::AddSampleData()
{
    ...
    auto Delegate = TAwsGameKitDelegate<const IntResult&>::CreateLambda([this](const IntResult& result) {AddDataReturnValue = GetResultMessage(result.Result);});
...
void AAwsGameKitAchievementsExamples::DeleteSampleData()
{
    ...
    auto Delegate = TAwsGameKitDelegate<const IntResult&>::CreateLambda([this](const IntResult& result){DeleteDataReturnValue = GetResultMessage(result.Result);});
...
void AAwsGameKitAchievementsExamples::CallListAchievementsForPlayerApi()
{
    ...
    auto Delegate = MakeAwsGameKitDelegate(this, &AAwsGameKitAchievementsExamples::OnListAchievementsComplete);
...
void AAwsGameKitAchievementsExamples::CallGetAchievementForPlayerApi()
{
    ...
    auto Delegate = MakeAwsGameKitDelegate(this, &AAwsGameKitAchievementsExamples::OnGetAchievementComplete);
...
void AAwsGameKitAchievementsExamples::CallUpdateAchievementForPlayerApi()
{
    ...
    auto Delegate = MakeAwsGameKitDelegate(this, &AAwsGameKitAchievementsExamples::OnUpdateAchievementComplete);
