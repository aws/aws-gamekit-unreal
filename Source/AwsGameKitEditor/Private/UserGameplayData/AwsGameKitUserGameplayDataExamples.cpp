...
bool AAwsGameKitUserGameplayDataExamples::InitializeIdentityLibrary()
{
    ...
    {
        // TODO:: Replace with UX-provided message
...
bool AAwsGameKitUserGameplayDataExamples::InitializeUserGameplayDataLibrary()
{
    ...
    {
        // TODO:: Replace with UX-provided message
        FMessageDialog::Open(EAppMsgType::Ok, FText::FromString("You need to deploy the User Gameplay Data feature first."));
        return false;
    }
...
void AAwsGameKitUserGameplayDataExamples::CallAddDataApi()
{
    ...
    if (AddBundleItemKeys.Num() != AddBundleItemValues.Num())
    {
        ...
        AddReturnValue = GameKit::StatusCodeToHexFStr(GameKit::GAMEKIT_ERROR_USER_GAMEPLAY_DATA_PAYLOAD_INVALID);
        return;
    }
...
void AAwsGameKitUserGameplayDataExamples::OnAddDataComplete(const IntResult& result)
{
    AddReturnValue = GetResultMessage(result);
}
...
{
    GetBundleKeyReturnValue = values.BundleMap;
}
...
{
    GetBundleItemReturnValue = value.BundleItemValue;
}
