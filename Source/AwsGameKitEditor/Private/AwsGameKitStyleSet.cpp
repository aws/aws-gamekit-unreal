...
AwsGameKitStyleSet::AwsGameKitStyleSet()
{
    ...
    FSlateImageBrush* undeployedIconBrush = new FSlateImageBrush(Style->RootToContentDir(TEXT("waiting.png")), FVector2D(15, 15));
    Style->Set("UndeployedIcon", undeployedIconBrush);
