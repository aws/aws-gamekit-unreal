...
private:
    ...
    UPROPERTY(Transient, EditInstanceOnly, Category = "4. Get Achievement", DisplayName = "Achivement ID")
    ...
    UPROPERTY(Transient, EditInstanceOnly, Category = "5. Update Achievement", DisplayName = "Achivement ID")
