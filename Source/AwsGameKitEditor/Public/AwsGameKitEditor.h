...
class AwsGameKitControlCenterLayout;
...
private:
    ...
    TSharedPtr<AwsGameKitControlCenterLayout> controlCenterLayout = nullptr;
...
public:
    ...
    TSharedPtr<AwsGameKitControlCenterLayout> GetControlCenterLayout();
