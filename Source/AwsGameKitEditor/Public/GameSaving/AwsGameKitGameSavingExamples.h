...
private:
    ...
    // Outputs
    UPROPERTY(Transient, VisibleInstanceOnly, Category = "2. Get All Game Save Statuses", DisplayName = "Response Status Code:")
    FString GetAllSlotSyncStatusesStatusCode;

    UPROPERTY(Transient, VisibleInstanceOnly, Category = "2. Get All Game Save Statuses", DisplayName = "Response Data (Cached Saves):")
    TArray<FGameSavingSlot> GetAllSlotSyncStatusesCachedSlots;
    ...
    // Outputs
    UPROPERTY(Transient, VisibleInstanceOnly, Category = "5. Delete Game Save", DisplayName = "Response Status Code:")
    FString DeleteSlotResponseStatusCode;

    UPROPERTY(Transient, VisibleInstanceOnly, Category = "5. Delete Game Save", DisplayName = "Response Data (Deleted Save):")
    FGameSavingSlot DeleteSlotResponseDeletedSlot;

    UPROPERTY(Transient, VisibleInstanceOnly, Category = "5. Delete Game Save", DisplayName = "Response Data (Cached Saves):")
